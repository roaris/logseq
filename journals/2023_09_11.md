# ssh-keygenについて
	- `ssh-keygen -t rsa`を実行すると、RSA暗号の公開鍵と秘密鍵のペアが作られる
		...
		- そしてfingerprintという値が表示される
			...
			- fingerprintを見ることで、公開鍵が変化したかのチェックを高速にすることが出来る
				- 公開鍵が変化しているということは、中間者攻撃の可能性がある([参考](https://superuser.com/questions/421997/what-is-a-ssh-key-fingerprint-and-how-is-it-generated))
		- -tオプションについて
